...
from .reader_csv_file import reader_csv
#/home/debian/Área de trabalho/flaskapprefatorado/app/uploads
files = os.path.join(UPLOADFOLDER, 'flaskappwebestoquehausz',
                     'app', 'admin', 'files', 'adminuploads')

adm = Blueprint('adm', __name__)
current_app.config["UPLOAD_FOLDER"] = os.path.join(UPLOADFOLDER,'flaskappwebestoquehausz','app','uploads')
    ...
    def upload_files(self):
        ...
        if filename != '':
            if '.csv' in filename:
                ...
                excel = reader_csv(os.path.join(current_app.config["UPLOAD_FOLDER"],'csv',filename))
...
def download_files_admin(name):
    ...
    path = os.path.join(UPLOADFOLDER, 'flaskappwebestoquehausz',
                        'app', 'admin', 'files', 'adminuploads')
